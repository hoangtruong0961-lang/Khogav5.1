...
const GameInput: React.FC<GameInputProps> = ({
    ...
    useEffect(() => {
        tavoRegistry.getInputValue = () => inputValueRef.current;
        tavoRegistry.setInputValue = (v: string) => setInputValue(v);
        tavoRegistry.appendInputValue = (v: string) => setInputValue(prev => prev + v);
        tavoRegistry.clearInputValue = () => setInputValue('');
        tavoRegistry.sendInput = () => handleSendInternal();
        
        return () => {
            tavoRegistry.getInputValue = null;
            tavoRegistry.setInputValue = null;
            tavoRegistry.appendInputValue = null;
            tavoRegistry.clearInputValue = null;
            tavoRegistry.sendInput = null;
        };
    }, [handleSendInternal]);
